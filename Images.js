...
this.IsChanged = function() { return false }
    ...
    {
         app.SendMail( "abueladiddy@gmail.com", "MediaPlayer Pro - Contact Us Email", 
    		      prompt("Enter the message content for the email:","Please help me!") );
    }
    
    //Create dialog window.
    var dlgPub = app.CreateDialog( "About Us - Images","Old");
		dlgPub.SetSize( 0.85, 0.69 );
