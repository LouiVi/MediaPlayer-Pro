...
function File( path, layContent )
{
    ...
    this.Load = function()
    {
        ...
        if( json ) 
        {
            ...
            txtNotes.SetText( data.text1 ? data.text1 : dfltText1 );
        }
        else self.Clear();
...
var imageFile1 = path+"/"+name+"/Img/original_"+name+".png";
    app.CopyFile( file, imageFile1 );
var imageFile2 = path+"/"+name+"/Img/thumbnail_"+name+".png";
        app.GetThumbnail( file, imageFile2, 48, 48 );
      
        var imageFile = path+"/"+name+"/Img/"+name+".png";
        app.GetThumbnail( file, imageFile, 480, 480 );
        img.SetImage( imageFile, 0.3972,-1 );
        img.imageFile = imageFile;
				img.originalPath = file;
				img.icon = imageFile2;
    ...
    //Create image label.
    var lab = app.CreateText( " Image File:",1.0,-1,"Left" ); 
    ...
    //Create image.
	var img = app.CreateImage( dfltImage, 0.3792, -1 );
	img.imageFile = dfltImage;
    ...
    //Create 'Notes' label.
    var lab = app.CreateText( " Item Text - Line #1:",1.0,-1,"Left"); 
